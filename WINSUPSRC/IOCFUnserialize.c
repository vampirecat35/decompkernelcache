...
#ifndef syslog
#define syslog(N,M,P) fprintf(stderr, M, P);
#endif
...
# define YYSTACK_RELOCATE(Stack_alloc, Stack)				\
    do									\
      {									\
	YYSIZE_T yynewbytes = (YYSIZE_T)0;						\
