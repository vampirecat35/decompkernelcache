...
/****************************************************************************************************
    ...
    run. At most one of the these is true, the rest are false.
        ...
        TARGET_OS_WINDOWS       - Generate code will run under Windows
        ...
        TARGET_OS_WIN32         - Same as TARGET_OS_WINDOWS. 
                                  Provided for backwards compatibility only. Note that "32" is 
                                  misleading; this is defined on both 32- and 64-bit Windows.
