...
{
       0,   154,   154,   157,   162,   167,   168,   169,   170,   171,
     172,   173,   174,   187,   190,   193,   196,   197,   202,   211,
     216,   219,   222,   225,   228,   231,   234,   237,   244,   247,
     250,   253,   256
};
#endif
...
#line 162 "IOCFUnserialize.yacc"
  ...
  case 5:
#line 167 "IOCFUnserialize.yacc"
    { (yyval) = buildDictionary(STATE, (yyvsp[(1) - (1)])); }
    break;

  case 6:
#line 168 "IOCFUnserialize.yacc"
    { (yyval) = buildArray(STATE, (yyvsp[(1) - (1)])); }
    break;

  case 7:
#line 169 "IOCFUnserialize.yacc"
